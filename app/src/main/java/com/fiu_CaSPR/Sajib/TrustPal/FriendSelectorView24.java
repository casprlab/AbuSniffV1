...
public class FriendSelectorView24 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (clickcount < 5) {
                    Toast.makeText(FriendSelectorView24.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    //Answering correctly
                   /* if ((Q1 != 0 && Q1 != 1 &&  Q1 != 2) && (Q2 != 0 && Q2 != 1 &&  Q2 != 2) && Q3 != 0 && Q4 != 0 && Q5 != 0) {
                        showNext();
                    }
                    else
                    {
                        Intent intent = new Intent(getApplicationContext(),Warning1.class);
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView24.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
