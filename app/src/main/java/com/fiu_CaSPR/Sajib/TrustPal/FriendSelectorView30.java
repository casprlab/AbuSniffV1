...
public class FriendSelectorView30 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView30.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void loadNextFriendView() {
        ...
        frndCounttextView.setText(currentPictureIndex + 1 + " of 30");
        new DownloadImageTask(FriendSelectorView30.propicView).execute("https://4.bp.blogspot.com/-Gme6AwEE-PA/WSaC_rQgHwI/AAAAAAAABPU/8_8h9e4zUSEgmZMuLqq0VsZ38a8Trb5BACLcB/s1600/5.jpg");
