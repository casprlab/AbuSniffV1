...
public class FriendSelectorView17 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView17.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    protected void saveMutualData() {
        ...
        Intent intent = new Intent(getApplicationContext(),FriendSelectorView18.class);
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView17.propicView).execute("https://4.bp.blogspot.com/-Nm2x9hwR0gk/WSaC_VRd4SI/AAAAAAAABPM/tzbwO_K3ms092Odfxvf2wvj3mWNBXiAWQCLcB/s1600/3.jpg");
