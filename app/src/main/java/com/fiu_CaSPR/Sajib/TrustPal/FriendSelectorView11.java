...
public class FriendSelectorView11 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView11.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView11.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
