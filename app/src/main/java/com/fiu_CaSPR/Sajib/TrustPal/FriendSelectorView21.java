...
public class FriendSelectorView21 extends Activity {
    ...
    private void loadViews() {
        ...
        nextButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(clickcount<5) {
                    Toast.makeText(FriendSelectorView21.this, "Please answer all questions before proceeding!", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    FriendSelectorView21.responseString += Q1+","+Q2+","+Q3+","+Q4+","+Q5+","+ friendsPage.friendsArray[currentPictureIndex][2]+","+difference;
                    FriendSelectorView21.responseString += "\n";
    ...
    private void loadNextFriendView() {
        ...
        new DownloadImageTask(FriendSelectorView21.propicView).execute(friendsPage.friendsArray[currentPictureIndex][25]);
